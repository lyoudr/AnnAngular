...
@Component({
  selector: 'app-shop-allitem',
  templateUrl: './shop-allitem.component.html',
  styleUrls: ['./shop-allitem.component.scss'],
  changeDetection : ChangeDetectionStrategy.OnPush
})
export class ShopAllitemComponent implements OnInit {
